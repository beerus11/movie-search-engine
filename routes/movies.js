...
router.post('/movies', function(req, res, next) {
  Movies().insert({ movie_title: req.body.title, movie_genre: req.body.genre, movie_rating: req.body.rating, movie_release_date: req.body.release_date}).then(function (result) {
    res.redirect('/movies');
  });
});
...
router.post('/movies/:id/edit', function(req, res, next) {
  var id = req.params.id;
  Movies().update({ movie_title: req.body.title,  movie_genre: req.body.genre, movie_rating: req.body.rating,  movie_release_date: req.body.release_date}).where({id: id}).then(function (result) {
    res.redirect('/movies/');
  });
});
